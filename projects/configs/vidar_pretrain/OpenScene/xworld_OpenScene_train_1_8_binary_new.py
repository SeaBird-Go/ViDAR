...
train_ann_pickle_root = f'data/openscene-v1.1/openscene_{data_split}_train_v2_filter.pkl'
val_ann_pickle_root = f'data/openscene-v1.1/openscene_trainval_val_v2_valid.pkl'
...
load_from = "work_dirs/xworld_OpenScene_mini_1_8_3future_binary_new/epoch_24.pth"