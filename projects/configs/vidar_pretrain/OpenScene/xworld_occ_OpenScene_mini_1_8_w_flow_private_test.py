...
Description: Forecast the private test occupancy.
'''
_base_ = [
...
num_classes = 12 # 2 or 12, 2 for binary occupancy, 12 for multi-class occupancy.
#############################################
...
model = dict(
    ...
    save_pred_dir='data/stbase_vision_only_train_full_e14_xworld_occ',
