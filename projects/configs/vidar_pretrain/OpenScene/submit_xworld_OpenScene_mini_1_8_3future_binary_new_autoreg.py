...
Date: 2024-06-01 13:07:19
Email: haimingzhang@link.cuhk.edu.cn
Description: Forecast in an auto-regressive manner.
'''
_base_ = [
...
#############################################
load_pred_occ = True
pred_occ_is_binary = False
# pred_occ_root_dir = "/mnt/data2/zhanghm/Code/OCC_Distill/results/openscene_vision_only_binary_stbase_e13_private"
pred_occ_root_dir = "data/stbase_vision_only_train_full_e14_xworld_occ"
num_classes = 2 # 2 or 12, 2 for binary occupancy, 12 for multi-class occupancy.
#############################################
...
model = dict(
    type='ViDARXWorld',
    _submission=True,
    _submission_path='test_submit_stbase_vision_only_train_full_e14_xworld_e24_autoreg',
    pred_occ_is_binary=pred_occ_is_binary,

    load_pred_occ=load_pred_occ,
...
val_ann_pickle_root = f'data/openscene-v1.1/meta_datas/private_test_wm/private_test_wm_v2.pkl'
...
test_pipeline = [
    ...
    dict(type='LoadOccupancyGT',
         load_pred_occ=load_pred_occ,
         pred_occ_is_binary=pred_occ_is_binary,
         use_binary_occ_inputs=(num_classes == 2),
         pred_occ_root_dir=pred_occ_root_dir),
    dict(type='DefaultFormatBundle3D', class_names=class_names),
