...
pred_occ_root_dir = "data/stbase_vision_only_train_full_e14_xworld_occ_wo_grid_sample"
...
model = dict(
    ...
    save_pred_dir='data/stbase_vision_only_train_full_e14_xworld_occ_wo_grid_sample',
