...
Date: 2024-04-24 11:18:10
Email: haimingzhang@link.cuhk.edu.cn
Description: The original ViDAR nuplan dataset need to predict the current frame,
we remove this requirement and only predict the future frames.
'''
