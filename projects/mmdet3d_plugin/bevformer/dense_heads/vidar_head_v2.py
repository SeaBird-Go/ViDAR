...
class ViDARHeadV2(ViDARHeadBase):
    def __init__(self,
    ...
    def _get_reference_gt_points(self,
        ...
        for frame_idx, src_frame_idx, tgt_frame_idx in zip(
            ...
            # 2. get transformation matrix.. NOTE: here we hard code the identity matrix.
            src_to_tgt = torch.eye(4).to(gt_points[0])[None]  # (1, 4, 4)
